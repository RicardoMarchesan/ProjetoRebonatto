 ...
 * @author Jader
 */
public class aleatoriatela extends javax.swing.JFrame {

    /**
     * Creates new form aleatoriatela
     */
    public aleatoriatela() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Mensagem Aleatória");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(aleatoriatela.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
